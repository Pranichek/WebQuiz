...
def render_graphics():
    ...
    ax.plot(list_index, graphics_tests, color='#FFB700', marker='o',
        markerfacecolor='#C99208', markersize=5)
    ax.set_title("test_graphic", color='white') 
    ax.grid(True, color="#D3D3D3", linewidth=0.8, linestyle='-', alpha=0.6)
    ...
    user_directory = abspath(join(__file__, "..", "static", "images", "graphic", "graphics_user"))
    ...
    right_directory = abspath(join(__file__, "..", "static", "images", "graphic", "graphics_user"))
