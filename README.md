...
```
Вставте даний код 
(У рядку EMAIL_PASSWORD вводимо пароль для пошти вашого веб-застосунку
 У EMAIL_USERNAME ви повинні ввести пошту за якою буде працювати ваш веб-застосунок 
...
<p>Цей папка (пакет) є складовою частиною веб-застосунку, що реалізує систему тестування користувачів. 
...
допомогою Flask-SocketIO для підтримки реального часу. У ньому реалізовано повний цикл роботи з тестами: від відображення інтерфейсу для різних типів користувачів (студент, ментор) до обробки результатів після завершення тесту з використанням WebSocket-з'єднання.</p>
